...
public class AndarAluguel extends Andar { //inicio da classe AndarAluguel
	 ...
	 */
	public CarroAluguel alugarCarro (ClienteAluguel cliente, int id) {
		if(!aluguelDisponivel) {
			return null; //se variavel aluguelDisponivel eh false
		}else {
			CarroAluguel carroAlugado = GerenciadorAluguel.alugarCarro(cliente, id, carrosAluguel); //chama funcao de GerenciadorAluguel para alugar
	...
	public String imprimirMapa() { 
		...
		saida = saida + "Ha " + numParaAluguel + " carros disponiveis para aluguel" + "\n";
