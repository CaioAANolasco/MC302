 ...
 * @Deprecated
 * 
 * As classes derivadas de Pessoa agora surpotam a interface Comparable. Use os metodos de ArrayList para ordenar objetos.
 * 
 *
 */
...
public abstract class MeuArray extends ArrayList < Pessoa > { //inicio da classe MeuArray, descontinuada
